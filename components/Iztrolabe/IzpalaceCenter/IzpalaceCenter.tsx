...
// import "./IzpalaceCenter.module.css";
...
export const IzpalaceCenter = ({
  ...
  return (
    ...
    >
      ...
      <ul className="basic-info grid grid-cols-2">
        {records.map((rec, idx) => (
          <Item key={idx} {...rec} />
        ))}
      </ul>
      <h3 className="center-title">运限信息</h3>
      <ul className="basic-info grid grid-cols-1 sm:grid-cols-2">
      ...
      <div className="horo-buttons hidden sm:flex">
        <span
